    ...
    <div className="max-w-md mx-auto px-4 py-12">
      <div className="bg-white rounded-3xl border border-slate-200/80 shadow-xl p-8 space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-black text-slate-900 font-serif">Citizen Registration</h1>
          <p className="text-xs text-slate-500">Create your account to unlock scheme bookmarks and grievance updates</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-bold text-slate-700 mb-1.5">State / UT</label>
            <select
              value={state}
